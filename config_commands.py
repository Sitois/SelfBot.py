...
CHANNEL_ID = "DEFAULT CHANNEL ID" # Laisser vide pour avoir la demande au démarrage.
add_channel = "add"
del_channel = "del"
...
hug_chat_email = "YOUR EMAIL"
hug_chat_password = "YOUR PASSWD"
#
ai_for_all = False # True / False

# fr: Activé NitroSniper (True = oui et False = non)
# en:
nitro_toggle = True # True / False
# fr: Salon où le Nitro sera envoyé.
# en: Channel ID for the Nitro Sniper.
notifier_channel_id = "CHANNEL ID"
# Notifier Account
notifier_token = "YOUR SECOND ACCOUNT TOKEN"
